...
Func OpenAbout()
   TrayTip("О программе " & $sProgramName & " " & $sProgramVersion, "Программа предназначена для смены фона рабочего стола по таймеру." & @LF & "Смена фона рабочего стола вручную производится двойным нажатием на иконку программы в трее." & @LF & "Все права на данную программу принадлежат Чеботову Николаю Валерьевичу. Ноябрь 2017 г.", 10, 1)
EndFunc
